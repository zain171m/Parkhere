const Footer = () => {
  return (
    ...
    <footer className="flex flex-col items-center bg-purple-50 text-center text-surface dark:bg-neutral-700 dark:text-white">
      <div className="container px-6 pt-6">
        ...
        <div className="mb-6">
          <p>From Driveways to Garages. Find Parking That Fits Your Needs.</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2">
          <div className="mb-6">
            ...
            <ul className="mb-0 list-none">
              ...
              <li>
                <a href="#!">Finding Parking</a>
              </li>
              <li>
                <a href="#!">List Your Spot</a>
              </li>
            </ul>
          </div>
      ...
      <div className="w-full p-4 text-center">
        © 2025 Parking Made Easier.
        <a className=""> All rights reserved</a>
      </div>
    </footer>
  );
};
